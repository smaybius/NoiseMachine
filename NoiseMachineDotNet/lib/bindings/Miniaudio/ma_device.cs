...
public unsafe partial struct ma_device
{
    ...
    [NativeTypeName("__AnonymousRecord_miniaudio_L7719_C5")]
    public _resampling_e__Struct resampling;

    [NativeTypeName("__AnonymousRecord_miniaudio_L7729_C5")]
    public _playback_e__Struct playback;

    [NativeTypeName("__AnonymousRecord_miniaudio_L7755_C5")]
    public _capture_e__Struct capture;

    [NativeTypeName("__AnonymousRecord_miniaudio_L7778_C5")]
    ...
    public unsafe partial struct _resampling_e__Struct
    {
        ...
        [NativeTypeName("__AnonymousRecord_miniaudio_L7724_C9")]
    ...
    {
        [FieldOffset(0)]
        [NativeTypeName("__AnonymousRecord_miniaudio_L7781_C9")]
        public _wasapi_e__Struct wasapi;

        [FieldOffset(0)]
        [NativeTypeName("__AnonymousRecord_miniaudio_L7822_C9")]
        public _dsound_e__Struct dsound;

        [FieldOffset(0)]
        [NativeTypeName("__AnonymousRecord_miniaudio_L7832_C9")]
        public _winmm_e__Struct winmm;

        [FieldOffset(0)]
        [NativeTypeName("__AnonymousRecord_miniaudio_L7875_C9")]
        public _jack_e__Struct jack;

        [FieldOffset(0)]
        [NativeTypeName("__AnonymousRecord_miniaudio_L7972_C9")]
