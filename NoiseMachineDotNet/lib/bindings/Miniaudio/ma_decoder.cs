...
public unsafe partial struct ma_decoder
{
    ...
    [NativeTypeName("__AnonymousRecord_miniaudio_L9926_C5")]
    ...
    {
        [FieldOffset(0)]
        [NativeTypeName("__AnonymousRecord_miniaudio_L9928_C9")]
        public _vfs_e__Struct vfs;

        [FieldOffset(0)]
        [NativeTypeName("__AnonymousRecord_miniaudio_L9933_C9")]
