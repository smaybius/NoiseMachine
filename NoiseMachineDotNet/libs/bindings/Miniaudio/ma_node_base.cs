...
namespace NoiseMachineDotNet.libs.bindings.Miniaudio
{
    public unsafe partial struct ma_node_base
    {
        ...
        public partial struct __inputBuses_e__FixedBuffer
        {
            ...
            public ref ma_node_input_bus this[int index] => ref AsSpan()[index];

            public Span<ma_node_input_bus> AsSpan()
            {
        ...
        public partial struct __outputBuses_e__FixedBuffer
        {
            ...
            public ref ma_node_output_bus this[int index] => ref AsSpan()[index];

            public Span<ma_node_output_bus> AsSpan()
            {
                return MemoryMarshal.CreateSpan(ref e0, 2);
            }
        }
