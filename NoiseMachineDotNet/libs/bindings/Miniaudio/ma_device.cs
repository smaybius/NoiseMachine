...
namespace NoiseMachineDotNet.libs.bindings.Miniaudio
{
    public unsafe partial struct ma_device
    {
        ...
        [NativeTypeName("__AnonymousRecord_miniaudio_L7730_C5")]
        public _resampling_e__Struct resampling;

        [NativeTypeName("__AnonymousRecord_miniaudio_L7740_C5")]
        public _playback_e__Struct playback;

        [NativeTypeName("__AnonymousRecord_miniaudio_L7766_C5")]
        public _capture_e__Struct capture;

        [NativeTypeName("__AnonymousRecord_miniaudio_L7789_C5")]
        public _Anonymous_e__Union Anonymous;

        public ref _Anonymous_e__Union._wasapi_e__Struct wasapi => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.wasapi, 1));

        public ref _Anonymous_e__Union._dsound_e__Struct dsound => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.dsound, 1));

        public ref _Anonymous_e__Union._winmm_e__Struct winmm => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.winmm, 1));

        public ref _Anonymous_e__Union._jack_e__Struct jack => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.jack, 1));

        public ref _Anonymous_e__Union._null_device_e__Struct null_device => ref MemoryMarshal.GetReference(MemoryMarshal.CreateSpan(ref Anonymous.null_device, 1));
        ...
        public unsafe partial struct _resampling_e__Struct
        {
            ...
            [NativeTypeName("__AnonymousRecord_miniaudio_L7735_C9")]
        ...
        {
            [FieldOffset(0)]
            [NativeTypeName("__AnonymousRecord_miniaudio_L7792_C9")]
            public _wasapi_e__Struct wasapi;

            [FieldOffset(0)]
            [NativeTypeName("__AnonymousRecord_miniaudio_L7833_C9")]
            public _dsound_e__Struct dsound;

            [FieldOffset(0)]
            [NativeTypeName("__AnonymousRecord_miniaudio_L7843_C9")]
            public _winmm_e__Struct winmm;

            [FieldOffset(0)]
            [NativeTypeName("__AnonymousRecord_miniaudio_L7886_C9")]
            public _jack_e__Struct jack;

            [FieldOffset(0)]
            [NativeTypeName("__AnonymousRecord_miniaudio_L7983_C9")]
