...
using static NoiseMachineDotNet.libs.bindings.Miniaudio.ma_format;
...
namespace NoiseMachineDotNet.libs.bindings.Miniaudio
{
    public static unsafe partial class Miniaudio
    {
        ...
        {
            return (float*)ma_offset_pcm_frames_ptr(p, offsetInFrames, ma_format_f32, channels);
        }
        ...
        {
            return (float*)ma_offset_pcm_frames_const_ptr(p, offsetInFrames, ma_format_f32, channels);
        }
        ...
        [DllImport("miniaudio", CallingConvention = CallingConvention.StdCall, ExactSpelling = true)]
