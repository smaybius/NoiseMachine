namespace NoiseMachineDotNet.libs.bindings.Miniaudio
{
    public unsafe partial struct ma_device_config
    {
        ...
        [NativeTypeName("__AnonymousRecord_miniaudio_L7053_C5")]
        ...
        [NativeTypeName("__AnonymousRecord_miniaudio_L7091_C5")]
        public _pulse_e__Struct pulse;

        [NativeTypeName("__AnonymousRecord_miniaudio_L7096_C5")]
        public _coreaudio_e__Struct coreaudio;

        [NativeTypeName("__AnonymousRecord_miniaudio_L7100_C5")]
        public _opensl_e__Struct opensl;

        [NativeTypeName("__AnonymousRecord_miniaudio_L7106_C5")]
