namespace NoiseMachineDotNet.libs.bindings.Miniaudio
{
    public unsafe partial struct ma_context_config
    {
        ...
        [NativeTypeName("__AnonymousRecord_miniaudio_L7249_C5")]
        public _alsa_e__Struct alsa;

        [NativeTypeName("__AnonymousRecord_miniaudio_L7253_C5")]
        public _pulse_e__Struct pulse;

        [NativeTypeName("__AnonymousRecord_miniaudio_L7259_C5")]
        public _coreaudio_e__Struct coreaudio;

        [NativeTypeName("__AnonymousRecord_miniaudio_L7266_C5")]
